...
2. **93+ signatures** — detects agents (Claude Code, Cursor, Copilot, Aider, OpenClaw, MiMo Code, ZCode, Antigravity, Zenflow, Devin, Replit, etc.), editors (Windsurf, Warp, JetBrains AI, Tabnine, Cody), runtimes (Ollama, LM Studio), VS Code extensions, models, MCP servers, Docker images, SDKs, and more.
...
- **Lines**: ~3.7K
- **Signatures**: 93+ (55 agents, 8 editors, 8 runtimes, 9 SDKs, + ComfyUI, model caches, MCP, Docker, plugins, configs, memory, instructions)
