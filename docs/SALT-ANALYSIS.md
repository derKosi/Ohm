...
2. **90+ signatures** — detects agents (Claude Code, Cursor, Copilot, Aider, OpenClaw, MiMo Code, ZCode, Antigravity, Zenflow, Devin, Replit, etc.), editors (Windsurf, Warp, JetBrains AI, Tabnine, Cody), runtimes (Ollama, LM Studio, llama.cpp, KTransformers, MLX, Jan, vLLM, GPT4All), VS Code extensions, models, MCP servers, Docker images, SDKs, and more.
...
- **Lines**: ~3.7K
- **Signatures**: 90+ (51 agents, 8 editors, 13 runtimes incl. disk/offload, 9 SDKs, + ComfyUI, model caches, MCP, Docker, plugins, configs, memory, instructions)
